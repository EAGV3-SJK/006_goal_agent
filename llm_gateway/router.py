...
LIMITS = {
    ...
    "anthropic":  {"rpm": 50,   "rpd": 1000,    "tpm": 200000,   "cooldown": 2,   "max_ctx": 200000},
    "lmstudio":   {"rpm": 9999, "rpd": 9999999, "tpm": 99999999, "cooldown": 0,   "max_ctx": 32000},
}
...
SHORTCUTS = {
    ...
    "a": "anthropic", "ant": "anthropic", "anthropic": "anthropic",
    "l": "lmstudio", "lm": "lmstudio", "lms": "lmstudio", "lmstudio": "lmstudio",
}
...
DEFAULT_ROUTER_ORDER = ["cerebras", "groq", "nvidia", "github", "anthropic"]
