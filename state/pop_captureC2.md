...
Name:   BirthdayRecallAnswer
Schema:
{
  "description": "Query C2 \u2014 recall mom's birthday from durable memory.",
  "properties": {
    "birthday": {
      "description": "The stored birthday date, e.g. '15 May 2026'",
      "title": "Birthday",
      "type": "string"
    },
    "note": {
      "description": "A brief human-readable note about the birthday.",
      "title": "Note",
      "type": "string"
    }
  },
...
### Per-Query JSON Schema sent to LLM (RawDecision_BirthdayRecallAnswer)
...
```json
{
  ...
  "properties": {
    ...
    "answer": {
      ...
      "default": null,
      "description": "Required when action=FINAL_ANSWER. Must conform to BirthdayRecallAnswer."
    }
  },
  "required": [
    "action",
  ...
  "title": "RawDecision_BirthdayRecallAnswer",
  "type": "object"
}
```
...
### Final-Answer Validation (BirthdayRecallAnswer)
